...
const pharse = document.querySelector(".mensage p");

const btnImg = document.querySelector(".cookie");
...
btnImg.addEventListener("click", imgClick);
btnReset.addEventListener("click", reset);

pharse.textContent = randomPharse();
